...
class RankedTasksScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RankedTasksScreen> createState() =>
      _RankedTasksScreenState();
}

class _RankedTasksScreenState
    extends ConsumerState<RankedTasksScreen> {
  @override
  void initState() {
    super.initState();
    ...
    return Scaffold(
      ...
      body: state.isRankLoading
          ...
          : state.rankedTasks.isEmpty
              ? const Center(
                  child: Text('No pending tasks to rank 🎉'))
              : ListView.builder(
