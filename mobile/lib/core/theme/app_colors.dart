...
class AppColors {
  ...
  /// Legacy note fills.
  static const noteRed = Color(0xFFFFEEF3);
  static const noteOrange = Color(0xFFFFF3E8);
  static const noteYellow = Color(0xFFFFF8D9);
  static const noteGreen = Color(0xFFE8FFF3);
  static const noteBlue = Color(0xFFEAF4FF);
  static const notePurple = Color(0xFFF3EFFF);
}
